...
[Serializable]
public class OldRoad : MonoBehaviour
{
    ...
    public OldRoad InitRoad(GameObject pRoadPrefab, Orientation pOrientation, int pId)
    {
    ...
    public OldRoad InitRoad(GameObject pRoadPrefab, int pId)
    {
        this._roadPrefab = pRoadPrefab;
    ...
    public OldRoad InitRoad(GameObject pRoadPrefab)
    {
        this._roadPrefab = pRoadPrefab;
        this._orientation = Orientation.North;
        this._id = NO_ID;
